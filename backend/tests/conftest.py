    ...
    with migration_engine.begin() as connection:
        ...
        connection.execute(
            text(
                ...
                "customer_generation_rate_events, inbound_webhook_deliveries, "
                "customer_messages, customer_conversations, "
                "messaging_channel_connections, operational_data_sources, "
